<?php
// main/app/content/adopter_home.php
// Assumes $defaultPetImage is available or set globally/passed
if (!isset($defaultPetImage)) $defaultPetImage = '../public/images/placeholder-pet.png';

$available_pets = getAvailablePetsForAdoption(); // From dashboard-logic.php
?>
<div class="dashboard-section">
    <h2>Pets Ready for a New Home</h2>
        ...
        <div class="pet-list-cards">
            ...
            ?>
                <div class="pet-list-card">
                    ...
                    <a href="index.php?page=pet_details&id=<?php echo $pet['pet_id']; ?>" class="action-button">View Details</a>
                </div>
            <?php endforeach; ?>
        </div>
    <?php else: ?>
        <p class="no-data-message">No pets are currently available for adoption. Please check back soon!</p>
    <?php endif; ?>
</div>